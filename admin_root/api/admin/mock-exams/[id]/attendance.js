...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // First, verify the mock exam exists
    let mockExam;
    try {
    ...
    for (const booking of bookings) {
      ...
      // Check if booking belongs to this mock exam
      if (existingBooking.properties.mock_exam_id !== mockExamId) {
        results.failed.push({
          bookingId: booking.bookingId,
          ...
          details: {
            expected: mockExamId,
            actual: existingBooking.properties.mock_exam_id
          }
        });
        continue;
      }
