...
/**
 * GET handler - Retrieve prerequisite associations for a mock exam
 */
async function getPrerequisites(req, res) {
  try {
    ...
    console.error('Prerequisites GET endpoint error:', error);
...
/**
 * POST handler - Create prerequisite associations
 */
async function addPrerequisite(req, res) {
  try {
    ...
    console.error('Prerequisites POST endpoint error:', error);
...
module.exports = { getPrerequisites, addPrerequisite };
