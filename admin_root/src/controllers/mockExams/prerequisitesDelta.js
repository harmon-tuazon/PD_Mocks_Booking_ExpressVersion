...
async function updatePrerequisitesDelta(req, res) {
  try {
    // Require admin authentication
    const user = await requireAdmin(req);
    const adminEmail = user?.email || 'admin@prepdoctors.ca';

    // Extract mock exam ID from route params (Express provides dynamic route params via req.params)
...
module.exports = { updatePrerequisitesDelta };
