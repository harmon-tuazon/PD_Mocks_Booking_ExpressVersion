...
const { getExamByIdFromSupabase, getBookingsFromSupabase, syncExamToSupabase, syncBookingsToSupabase } = require('../../services/supabase-data');
...
const get = async (req, res) => {
  try {
    ...
    try {
      console.log(`[SUPABASE] Fetching exam ${mockExamId} from Supabase`);
      ...
      console.error(`[SUPABASE ERROR] Non-blocking error:`, supabaseError.message);
