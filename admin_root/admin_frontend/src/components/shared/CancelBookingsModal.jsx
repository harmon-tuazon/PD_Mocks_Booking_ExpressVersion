 ...
 * Modal dialog for batch booking cancellation with single-step confirmation
 *
 * Features:
 * - Single-step confirmation with always-visible input field
 * - Confirm button disabled until correct number is entered
                      ...
                      <ul className="text-sm text-red-800 dark:text-red-300 space-y-1">
                        {displayBookings.map((booking, index) => (
                          <li key={booking.id || index} className="flex items-center">
                            ...
                            {booking.email && (
                              <span className="text-red-600 dark:text-red-400 ml-1 text-xs">
                                ({booking.email})
                              </span>
                            )}
                          </li>
