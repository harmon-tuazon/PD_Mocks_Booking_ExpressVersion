            ...
            <div className="col-span-2">
              ...
              {isEditing ? (
                <PrerequisiteSelector
                  selectedExams={displayData.prerequisite_exams || []}
                  availableExams={availableExams}
                  onChange={(exams) => onFieldChange('prerequisite_exams', exams)}
                  onBlur={() => onFieldBlur('prerequisite_exams')}
                />
              ) : (
                <PrerequisiteDisplay examIds={displayData.prerequisite_exams || []} />
              )}
            </div>
          )}
        </div>
