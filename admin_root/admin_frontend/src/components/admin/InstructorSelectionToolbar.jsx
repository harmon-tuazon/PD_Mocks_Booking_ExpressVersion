...
/**
 * Toolbar component that appears when instructors are selected
 * Shows selection count and controls for bulk operations
 */
const InstructorSelectionToolbar = ({
  selectedCount,
  totalCount,
  onClearAll,
  onExitMode,
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-sm font-medium text-gray-900 dark:text-gray-100">
              {selectedCount} of {totalCount} instructors selected
            </span>
          </div>
            ...
            <button
              ...
              className={`inline-flex items-center px-4 py-2 text-sm font-medium rounded-md border-2 transition-colors ${
                isSubmitting
                  ...
                  : 'text-white bg-primary-600 border-primary-600 hover:bg-primary-700 hover:border-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:bg-primary-600 dark:border-primary-600 dark:hover:bg-primary-700 dark:hover:border-primary-700 dark:focus:ring-offset-gray-900'
              }`}
              aria-label="Toggle status for selected instructors"
            >
              {isSubmitting ? (
...
export default InstructorSelectionToolbar;
