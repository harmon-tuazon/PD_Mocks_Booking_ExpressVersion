/**
 * SlotSelectionToolbar Component
 * Toolbar that appears when slots are selected, showing bulk actions
 */
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-sm font-medium text-gray-900 dark:text-gray-100">
              {selectedCount} of {totalCount} slots selected
            </span>
          </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          {selectedCount > 0 && (
            <button
              ...
              aria-label="Toggle status for selected slots"
            >
              {isSubmitting ? (
          ...
          {selectedCount > 0 && (
            <button
              ...
              aria-label="Clone selected slots"
            >
              {isSubmitting ? (
                <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
...
export default SlotSelectionToolbar;
