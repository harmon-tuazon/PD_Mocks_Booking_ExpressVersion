...
const ErrorDisplay = ({
  ...
  const variants = {
    error: {
      ...
      buttonColor: 'bg-red-100 hover:bg-red-200 text-red-900',
      icon: (
    ...
    warning: {
      ...
      buttonColor: 'bg-yellow-100 hover:bg-yellow-200 text-yellow-900',
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    ...
    info: {
      ...
      buttonColor: 'bg-blue-100 hover:bg-blue-200 text-blue-900',
      icon: (
        <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        {onDismiss && (
          <div className="ml-auto pl-3">
            <div className="-mx-1.5 -my-1.5">
              <button
                onClick={onDismiss}
                className={`inline-flex rounded-md p-1.5 ${style.iconColor} hover:${style.bgColor} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-${style.bgColor} focus:ring-${style.borderColor}`}
              >
