...
import { FiAlertCircle, FiX, FiCalendar, FiInfo } from 'react-icons/fi';

const BookingTimeWarningModal = ({
  isOpen,
  examDate,
  daysUntilExam,
  onClose,
      ...
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        >
          ...
          <div className="bg-white dark:bg-dark-card px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                <h3 className="text-lg leading-6 font-headline font-semibold text-yellow-800 dark:text-yellow-400" id="modal-title">
                ...
                <div className="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-700">
                  <div className="flex items-start gap-2">
                    <FiCalendar className="w-5 h-5 text-yellow-600 dark:text-yellow-400 flex-shrink-0 mt-0.5" />
                    <div>
          ...
          <div className="bg-gray-50 dark:bg-dark-bg px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-3">
            ...
            <button
              type="button"
              onClick={onViewExamTypes}
              className="mt-3 w-full sm:mt-0 sm:w-auto inline-flex justify-center rounded-md border border-gray-300 dark:border-dark-border shadow-sm px-4 py-2 bg-white dark:bg-dark-hover text-base font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-dark-card focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 sm:text-sm transition-colors duration-200"
            >
              View All Exam Types
            </button>
          </div>
...
BookingTimeWarningModal.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  examDate: PropTypes.string,
  daysUntilExam: PropTypes.number,
  onClose: PropTypes.func.isRequired,
  onViewExamTypes: PropTypes.func.isRequired
};

BookingTimeWarningModal.defaultProps = {
  examDate: null,
  daysUntilExam: null
};

export default BookingTimeWarningModal;
