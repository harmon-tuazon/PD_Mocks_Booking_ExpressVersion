  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg">
      <div className="container-app py-12">
        ...
        {/* Existing booking warning - compact inline style */}
        {existingBookingDates.length > 0 && (
          <div className="mb-3 px-3 py-1.5 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-md inline-flex items-center">
            <svg className="w-4 h-4 text-amber-500 mr-1.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
            </svg>
            <span className="text-xs text-amber-700 dark:text-amber-300">
              {existingBookingDates.length} existing booking{existingBookingDates.length > 1 ? 's' : ''} (highlighted in amber)
            </span>
          </div>
        )}
